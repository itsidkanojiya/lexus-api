...
class SolutionController extends Controller
{
        ...
        public function getSolutions(){
            ...
            $solutions = DB::table('solutions')->where('deleted_at')->where(
       ...
       $bookId= DB::table('solutions')->insertGetId($validation);
            return response([
        ...
        public function editSolution(Request $request){
            ...
            $bookId= DB::table('solutions')->where('id',$request->id)->update($validation);
            return response([
                'message' => 'Solutions edited Successfully',
                ],200);
        }
}
